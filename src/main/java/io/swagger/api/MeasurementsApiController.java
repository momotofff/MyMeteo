...
public class MeasurementsApiController implements MeasurementsApi {
    ...
    public ResponseEntity<MeasurementResponse> measurementsPost(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody Measurement body
) {
