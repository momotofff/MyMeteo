...
public interface SensorsApi
{
    ...
    ResponseEntity<SensorRegistrationResponse> sensorsPost(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody Sensor body
);
